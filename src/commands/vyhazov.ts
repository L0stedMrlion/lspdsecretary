...
export const data = new SlashCommandBuilder()
	.setName("vyhazov")
	.setDescription("Odešle oficiální oznámení o ukončení pracovního poměru")
	.addUserOption((option) =>
		option
			.setName("user")
			.setDescription("Hráč, kterému bude odesláno oznámení")
			.setRequired(true),
	)
	.addStringOption((option) =>
		option
			.setName("reason")
			.setDescription("Důvod ukončení pracovního poměru")
			.setRequired(true),
	)
	.addStringOption((option) =>
		option
			.setName("signiture")
			.setDescription("Tvůj podpis (např. Jméno a Hodnost)")
			.setRequired(true),
	);
