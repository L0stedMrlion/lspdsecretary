...
const CPZ_CHANNELS: Record<string, string> = {
  ...
  CPZ1SH: "1521261404269576365",
  CPZ2SH: "1521261433747279925",
  CPZ3SH: "1521261464495718621L",
  ...
  .addStringOption((option) =>
    option
      ...
      .addChoices(
        ...
        { name: "CPZ 1 (SAHP)", value: "CPZ1SH" },
        { name: "CPZ 2 (SAHP)", value: "CPZ2SH" },
        { name: "CPZ 3 (SAHP)", value: "CPZ3SH" },
